...
(function () {
    ...
    window.I18N = {
        tr: {
            ...
            'settings.section.ai': 'Yapay Zeka',
            'settings.section.mcp': 'Araçlar (MCP)',
            'settings.section.audioIn': 'Ses Girişi',
            'settings.section.audioOut': 'Ses Çıkışı',
            'settings.section.avatar': 'Avatar',
            'settings.section.apiKeys': 'API Anahtarları',
            'settings.restartChip': 'Yeniden başlatınca geçerli',
            'settings.savedRestart': 'Kaydedildi — yeniden başlatınca geçerli.',
            'settings.saveFail': 'Kaydedilemedi: {error}',
            ...
            'settings.label.engine': 'Motor',
            'settings.label.skin': 'Görünüm',
            'settings.model.placeholder': 'ör. gpt-4o-mini',
            'settings.provider.openai': 'OpenAI',
            'settings.provider.ollama': 'Ollama (Yerel)',
            'settings.audio.none': 'Ses girişi cihazı bulunamadı',
            'settings.audio.systemDefault': 'Sistem varsayılanı',
            'settings.tts.loading': 'Bakılıyor...',
            'settings.tts.auto': 'Otomatik: {provider}',
            'settings.tts.unavailable': 'TTS kullanılamıyor',
            'settings.tts.note': 'Motor, mevcut API anahtarlarına göre otomatik seçilir.',
            ...
            'settings.keys.saving': 'Kaydediliyor...',
            'settings.keys.saved': 'Kaydedildi',
            'settings.keys.error': 'Hata',
            'settings.preview.noBackend': 'Arka uç yok — tarayıcı önizleme modu.',
